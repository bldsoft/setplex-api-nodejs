import type { NoraAPIGetSubscriberByEmailRequest, NoraAPIGetSubscriberByEmailResponse, NoraAPIGetSubscriberInfoRequest, NoraAPIGetSubscriberRequest, NoraAPIGetSubscriberResponse, NoraAPIGetSubscribersByParametersRequest, NoraAPIGetSubscribersByParametersResponse, NoraApiSubscriberAcceptToaRequest, NoraApiSubscriberAcceptToaResponse, NoraApiSubscriberAutoPaySubscriptionRequest, NoraApiSubscriberAutoPaySubscriptionResponse, NoraApiSubscriberCancelSubscriptionRequest, NoraApiSubscriberCancelSubscriptionResponse, NoraApiSubscriberGetToaRequest, NoraApiSubscriberGetToaResponse, NoraApiSubscriberSubscriptionContentSetsRequest, NoraApiSubscriberSubscriptionContentSetsResponse, NoraApiSubscriberSubscriptionGetRequest, NoraApiSubscriberSubscriptionGetResponse, NoraApiSubscriberSubscriptionPartnersProductsRequest, NoraApiSubscriberSubscriptionPartnersProductsResponse, NoraApiSubscriberValidateUsernameRequest, NoraApiSubscriberValidateUsernameResponse, NoraApiSusbscriberUnassignDeviceRequest, NoraApiSusbscriberUnassignDeviceResponse, NoraAPIUpdateSubscriberInfoRequest, NoraAPIUpdateSubscriberResponse } from './types/subscribers.types';
...
export declare class SubscribersAPI {
    ...
    acceptToa(data: NoraApiSubscriberAcceptToaRequest, config?: AxiosRequestConfig): Promise<NoraApiSubscriberAcceptToaResponse>;
}
